...
logger = setup_logger(
    '/share/wangqixun/workspace/github_project/redpy/redpy/grpc/server/diffusion/log/ty_log.log',
    name='taiyiDiffusionServer'
)
...
class Diffusion(pb2_grpc.DiffusionServicer):
    def __init__(self):
        ...
        self.pipe = StableDiffusionPipeline.from_pretrained(
            "/share/wangqixun/workspace/github_project/diffusers/checkpoint/models--IDEA-CCNL--Taiyi-Stable-Diffusion-1B-Chinese-v0.1/snapshots/a078ea53d918ea621f0c0053d52d521448156af5",
    ...
    def infer_one_text(self, request, context):
        try:
            ...
            t3 = time.time()
            logger.info(f'   [{t3-t2:.4f}] Taiyi-Stable-Diffusion-1B-Chinese-v0.1 infer finish.')
