...
logger = setup_logger(
    '/share/wangqixun/workspace/github_project/redpy/redpy/grpc/server/diffusion/log/hf_log.log',
    name='hfDiffusionServer'
)
...
class Diffusion(pb2_grpc.DiffusionServicer):
    def __init__(self):
        ...
        self.pipe = StableDiffusionPipeline.from_pretrained(
            "/share/wangqixun/workspace/github_project/diffusers/checkpoint/sd-pokemon-model-zh-rdma-v5-11_50000",
            # '/share/wangqixun/workspace/github_project/diffusers/checkpoint/v0_10000',
            # '/share/wangqixun/workspace/github_project/diffusers/checkpoint/sd-pokemon-model-en-rdma-finetune-v2_20000',
    ...
    def infer_one_text(self, request, context):
        try:
            ...
            t3 = time.time()
            logger.info(f'   [{t3-t2:.4f}] sd-hf infer finish.')
