...
logger = setup_logger(
    '/share/wangqixun/workspace/github_project/redpy/redpy/grpc/server/diffusion/log/wqx_log.log',
...
class Diffusion(pb2_grpc.DiffusionServicer):
    def __init__(self):
        ...
        self.pipe = StableDiffusionPipeline.from_pretrained(
            "/share/wangqixun/workspace/github_project/diffusers/checkpoint/Chilloutmix-Ni",
            custom_pipeline="lpw_stable_diffusion",
            torch_dtype=torch.float16,
        ).to("cuda")
        self.pipe.scheduler = DPMSolverMultistepScheduler.from_config(self.pipe.scheduler.config)
        # self.pipe.vae = AutoencoderKL.from_pretrained('/share/wangqixun/workspace/github_project/diffusers/checkpoint/stabilityai/sd-vae-ft-mse')
    ...
    def infer_one_text(self, request, context):
        try:
            ...
            t3 = time.time()
            logger.info(f'   [{t3-t2:.4f}] sd-wqx infer finish.')
