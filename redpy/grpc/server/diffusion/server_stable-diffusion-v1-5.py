...
logger = setup_logger(
    '/share/wangqixun/workspace/github_project/redpy/redpy/grpc/server/diffusion/log/sd_log.log',
    name='sdDiffusionServer'
)
...
class Diffusion(pb2_grpc.DiffusionServicer):
    def __init__(self):
        ...
        self.pipe = StableDiffusionPipeline.from_pretrained(
            "/share/wangqixun/workspace/github_project/diffusers/checkpoint/stable-diffusion-v1-5",
    ...
    def infer_one_text(self, request, context):
        try:
            ...
            t3 = time.time()
            logger.info(f'   [{t3-t2:.4f}] stable-diffusion-v1-5 infer finish.')
